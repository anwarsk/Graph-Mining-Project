...
public class LdaGibbsSampler {
     ...
     * burn-in period
     */
    private static int BURN_IN = 500;
     ...
     * @param data
     */
    public LdaGibbsSampler(int[][] documents, int V, long rand_seed) {

        this.documents = documents;
        this.V = V;
        this.random = new Random(rand_seed);
        // Replacing all Math.random() with random.nextDouble()
    }
    ...
    public void initialState(int K) {
        ...
        for (int m = 0; m < M; m++) {
            ...
            z[m] = new int[N];
            for (int n = 0; n < N; n++) {
                int topic = (int) (random.nextDouble() * K);
                z[m][n] = topic;
    ...
    public void gibbs(int K, double alpha, double beta) {
        ...
        System.out.println("LDA: Sampling " + ITERATIONS
    ...
    public static void main(String[] args) {
        ...
        LdaGibbsSampler lda = new LdaGibbsSampler(documents, V, 123456 /* rand seed */);
